  ...
  const views = [
    {
      ...
      tree: node("AI 학습 지식", "ai-learning", { status: "learning", children: [
        ...
        node("PyTorch", "pytorch", { status: "learning", href: "roadmaps/roadmap_pytorch.html", children: [
          ...
          node("학습 원리", "training-loop", { status: "learning", children: [node("Loss", "loss", { status: "verified", href: "wiki/pytorch/pytorch_linear_regression_learning.html" }), node("Gradient·Autograd", "autograd", { status: "verified", href: "wiki/pytorch/pytorch_linear_regression_learning.html" }), node("Optimizer", "optimizer", { status: "learning", href: "roadmaps/roadmap_pytorch.html" })] }),
        ] }),
    ...
    },
    {
      ...
      tree: node("재현 가능한 ML 시스템", "ml-system", { status: "learning", children: [
        ...
        node("4. PyTorch 학습", "training-loop", { status: "learning", children: [node("Dataset·DataLoader", "data-loader", { status: "learning", href: "roadmaps/roadmap_pytorch.html" }), node("nn.Module", "nn-module", { status: "learning", href: "roadmaps/roadmap_pytorch.html" }), node("Loss·Autograd·Optimizer", "autograd", { status: "learning", href: "wiki/pytorch/pytorch_linear_regression_learning.html" })] }),
    ...
    },
    {
      ...
      tree: node("한국어 Kubernetes Function Calling", "k8s-function-calling-project", { status: "learning", href: "wiki/projects/ko-k8s-function-calling.html", children: [
        ...
        node("학습", "project-training", { status: "learning", href: "wiki/projects/k8s-function-calling-training-code.html", children: [node("Qwen", "qwen", { status: "reference", href: "wiki/llm-systems/lora_adapters_qwen_learning.html" }), node("LoRA", "lora", { status: "reference", href: "wiki/llm-systems/lora_adapters_qwen_learning.html" }), node("Loss·Optimizer", "training-loop", { status: "learning", href: "wiki/projects/k8s-function-calling-training-code-explained.html" })] }),

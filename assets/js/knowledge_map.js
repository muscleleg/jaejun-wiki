  ...
  const views = [
    ...
    },
    {
      ...
      tree: node("Transformer", "transformer", { status: "verified", href: "wiki/transformer/transformer_learning.html", children: [
        ...
        node("Attention 입력", "attention-input", { status: "verified", children: [node("Q·K·V Projection", "qkv-projection", { status: "verified", href: "wiki/transformer/transformer_projection_learning.html", children: [node("GPT-2 QKV Projection과 KV Cache", "kv-cache", { status: "verified", href: "wiki/transformer/transformer_kv_cache_qkv_projection_learning.html" }), node("KV Cache와 input_ids 전달 흐름", "kv-cache-input-flow", { status: "verified", href: "wiki/transformer/transformer_kv_cache_input_ids_flow_learning.html" })] }), node("행렬곱", "matrix-multiplication", { status: "verified", href: "wiki/transformer/transformer_projection_learning.html" })] }),

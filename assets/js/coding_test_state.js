window.CODING_TEST_STATE = {
  journey: {
    ...
    summary: "각 점은 문제를 한 번 맞힌 기록이 아니라, 선택 이유·상태 변화·복잡도를 설명하고 새 조건에 다시 적용해야 닫히는 성취 관문입니다.",
    ...
    milestones: [
      ...
      },
      {
        ...
        goal: "프로그래머스 입국심사에서 사람을 직접 배치하는 문제를 ‘주어진 시간 안에 n명을 처리할 수 있는가?’라는 가능 여부 문제로 바꿉니다. 단조롭게 변하는 범위, left·right의 의미, mid 판정과 종료 뒤 최소 가능 시간이 어느 변수인지 설명하고 구현합니다.",

  ...
  journey: {
    ...
    milestones: [
      ...
      },
      {
        ...
        href: "wiki/coding-test/index.html#first-loop",
        goal: "배달 문제에서 가중치가 다르면 일반 BFS로 최소 비용을 보장할 수 없는 이유를 설명하고, 거리 갱신과 우선순위 Queue를 연결합니다. 자료 없이 배달을 재구현한 뒤 땅따먹기·정수 삼각형·등굣길의 안내 풀이로 dp[r][c]의 뜻, 점화식·초깃값·계산 순서를 빠르게 장착합니다.",
        evidence: "2026-08-31 배달 문제를 안내에 따라 구현하며 출발점 1의 distance를 0, 나머지를 무한대로 두고, 양방향 인접 리스트·최소 Heap·거리 갱신·낡은 Heap 후보 제거의 역할을 설명했습니다. 전체 정답을 안내받았으므로 아직 완료가 아니며, 다음에는 자료 없이 다시 구현해 제출하고 시간 복잡도를 설명해야 합니다."
      },
      {
